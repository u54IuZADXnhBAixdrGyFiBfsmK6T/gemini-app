...
const PARTS = [
  {
    ...
    zones: [
      { key: 'middle', label: '中部・全体（ベース）' }, { key: 'upper', label: '上部（鎖骨側）' }, { key: 'lower', label: '下部（腹側・輪郭）' }
    ]
  },
  {
    key: 'shoulder', title: 'Shoulder', subtitle: '',
    zones: [
      { key: 'overall', label: '全体・プレス系' },{ key: 'front', label: '前部（フロント）' },{ key: 'side', label: '中部（サイド）' },{ key: 'rear', label: '後部（リア）' }
    ]
  },
  {
    key: 'back', title: 'Back', subtitle: '',
    zones: [
      { key: 'width', label: '広背筋（広がり）' },{ key: 'thickness', label: '僧帽筋・中背部（厚み）' },{ key: 'low', label: '下背部・全体' }
    ]
  },
  {
    key: 'arms', title: 'Arms', subtitle: '',
    zones: [
      { key: 'biceps', label: '上腕二頭筋（力こぶ）' },{ key: 'triceps', label: '上腕三頭筋（二の腕）' },{ key: 'forearms', label: '前腕（肘から手首）' }
    ]
  },
  {
    key: 'legs', title: 'Lesg', subtitle: '',
    zones: [
      { key: 'overall', label: '全体・スクワット系' },{ key: 'quads', label: '大腿四頭筋（前もも）' },{ key: 'hams', label: 'ハム・臀部（裏もも・尻）' },
  ...
  },
  {
    ...
    zones: [
      { key: 'front', label: '腹直筋（シックスパック）' },{ key: 'side', label: '腹斜筋（くびれ・横腹）' },{ key: 'core', label: '体幹・コア' }
    ]
  }
];
